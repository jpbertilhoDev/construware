          ...
          <div className="space-y-10 lg:pr-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              <Button 
                ...
                className="group bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white px-10 py-6 text-xl font-semibold rounded-2xl shadow-2xl shadow-orange-500/30 hover:shadow-orange-500/50 transition-all duration-300 transform hover:scale-105 hover:-translate-y-1"
              >
                ...
                <div className="mt-8 p-6 bg-gradient-to-r from-slate-700/30 to-slate-600/30 rounded-2xl border border-slate-600/50 backdrop-blur-sm">
                 ...
                 <div className="mt-6">
                   <button 
                     ...
                     className="w-full bg-gradient-to-r from-orange-500/30 to-red-500/30 hover:from-orange-500/50 hover:to-red-500/50 border border-orange-500/50 text-orange-300 hover:text-white py-4 px-6 rounded-xl transition-all duration-300 text-sm font-semibold backdrop-blur-sm shadow-lg hover:shadow-orange-500/25"
                   >
