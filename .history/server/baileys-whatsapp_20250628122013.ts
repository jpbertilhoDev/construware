...
// Importação alternativa caso a anterior não funcione
...
class WhatsAppBaileys {
  ...
  async initialize(): Promise<void> {
    ...
    try {
      ...
      // Se makeWASocket não estiver definido, tentar importação alternativa
      if (typeof makeWASocket !== 'function') {
        console.log("❌ makeWASocket não é função, tentando importação alternativa...");
        
        // Tentar require
        const baileys = require("baileys");
        console.log("🔍 Baileys require:", Object.keys(baileys));
        
        if (baileys.default && typeof baileys.default === 'function') {
          console.log("✅ Usando baileys.default");
          ...
          console.log("✅ Usando baileys.makeWASocket");
          ...
          throw new Error("Não foi possível encontrar a função makeWASocket");
        }
      } else {
        // Usar importação normal
      ...
      console.log("✅ Baileys configurado!");
