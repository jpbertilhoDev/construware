  ...
  app.post(
    ...
    async (req, res) => {
      try {
        ...
        const analysis = {
          type: 'business',
          insights: ['Dados estruturados identificados', 'Oportunidades de automação'],
          recommendations: ['Implementar dashboard', 'Automatizar processos'],
          confidence: 0.9
        };
        ...
        competitors: [
          {
            ...
            weaknesses: ['Tecnologia antiga'],
            pricing: '€5.000+',
            marketShare: '35%'
          }
        ],
        opportunities: ['Mercado digital em crescimento'],
        recommendations: ['Foco em inovação'],
        marketSize: '€500M+'
      };
