...
<body>
    <div class="header">
        ...
        <div style="float: right; margin-top: -40px; font-size: 10px;">${new Date().toLocaleDateString(
          "pt-PT"
        )}</div>
    </div>
...
<body>
    <div class="header">
        ...
        <div style="float: right; margin-top: -40px; font-size: 10px;">${
          clientData.generatedAt
        }</div>
    </div>
    ...
    <div class="section">
        ...
        <div class="client-info">
            ...
            <p><strong>Principal Desafio:</strong> ${
              clientData.mainChallenge
            }</p>
...
function generateRecommendation(userData: any): string {
  const recommendations = {
    Construction:
      "Sistema ERP especializado para construção com gestão de obras, materiais, equipamentos e relatórios de progresso em tempo real. Inclui módulos de orçamentação automática e controlo de custos.",
    Consulting:
      "Plataforma CRM avançada com gestão de projetos, time tracking automático, faturação inteligente e dashboards de performance. Sistema otimizado para equipas de consultoria.",
    "E-commerce":
      "Solução e-commerce completa com gestão de stock automática, analytics avançados, marketing automation e integração multi-canal para maximizar vendas.",
    Restaurant:
      "Sistema POS integrado com gestão de delivery, controlo de ingredientes, reservas automáticas e análises de vendas específicas para restauração.",
    Services:
      "Plataforma de gestão de serviços com agendamento inteligente, gestão de técnicos, histórico completo de clientes e faturação automática.",
    Outro:
      "Sistema personalizado desenvolvido especificamente para as necessidades do seu setor, com funcionalidades sob medida e integração com sistemas existentes.",
  };
