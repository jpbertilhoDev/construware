...
🚨 *LEAD QUALIFICADO - SEGUIMENTO PRIORITÁRIO!*`;
  ...
  async sendMessage(number: string, message: string, options?: any): Promise<any> {
    try {
      if (!this.isConnected) {
  ...
  private generatePersonalizedReportHTML(userData: any): string {
    const savings = this.calculateROI(userData.businessType, userData.employees);
...
<body>
        ...
        <div class="client-info">
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">${userData.company || userData.name}</div>
                </div>
                <div class="info-item">
    ...
    <div class="section">
        ...
        <div class="recommendation">
            ...
            <p style="font-size: 15px; line-height: 1.6;">${this.generateRecommendation(userData)}</p>
