...
import { Calendar, Clock, ArrowLeft, Share2, ExternalLink, ChevronRight, User, CheckCircle, Target, Lightbulb } from "lucide-react";
                    ...
                    <article className="bg-white/[0.01] backdrop-blur-sm border border-white/[0.05] rounded-2xl overflow-hidden hover:border-white/10 hover:bg-white/[0.02] transition-all duration-500 hover:-translate-y-2">
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <ArrowLeft className="h-4 w-4 text-white/40 group-hover:text-orange-400 group-hover:translate-x-1 transition-all" />
                        </div>
                      </div>
                    </article>
                  </Link>
