      ...
      <section className="py-20 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              <div className="mb-8">
                <Badge className="mb-4 bg-orange-500/10 text-orange-400 border-orange-500/20 text-base md:text-lg font-bold">
                  ...
                  <form className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-3">
                        <Label htmlFor="firstName" className="text-sm md:text-base font-bold text-white/80">Nome *</Label>
                        <Input 
                          id="firstName" 
                          placeholder="João" 
                          className="h-14 bg-white/[0.03] border-white/[0.10] text-white text-lg font-medium placeholder:text-white/40 rounded-xl focus:bg-white/[0.06] focus:border-orange-500/50 transition-all" 
                        />
                      </div>
                      <div className="space-y-3">
                        <Label htmlFor="lastName" className="text-sm md:text-base font-bold text-white/80">Sobrenome *</Label>
                        <Input 
                          id="lastName" 
                          placeholder="Silva" 
                          className="h-14 bg-white/[0.03] border-white/[0.10] text-white text-lg font-medium placeholder:text-white/40 rounded-xl focus:bg-white/[0.06] focus:border-orange-500/50 transition-all" 
                    ...
                    <div className="space-y-3">
                      <Label htmlFor="email" className="text-sm md:text-base font-bold text-white/80">Email *</Label>
                      <Input 
                        id="email" 
                        type="email"
                    ...
                    <div className="space-y-3">
                      <Label htmlFor="company" className="text-sm md:text-base font-bold text-white/80">Empresa</Label>
                      <Input 
                        id="company" 
                    ...
                    <div className="space-y-3">
                      <Label htmlFor="subject" className="text-sm md:text-base font-bold text-white/80">Assunto *</Label>
                      <select className="w-full h-14 bg-white/[0.03] border border-white/[0.10] text-white text-lg font-medium rounded-xl focus:bg-white/[0.06] focus:border-orange-500/50 transition-all px-4">
                        <option value="">Selecione um assunto</option>
                        <option value="demo">Demonstração da Plataforma</option>
                        <option value="quote">Orçamento / Preços</option>
                    ...
                    <div className="space-y-3">
                      <Label htmlFor="message" className="text-sm md:text-base font-bold text-white/80">Mensagem *</Label>
                      <Textarea 
                        id="message" 
                        placeholder="Conte-nos sobre seu projeto, objetivos e como podemos ajudar..."
                        rows={6}
                        className="bg-white/[0.03] border-white/[0.10] text-white text-lg font-medium placeholder:text-white/40 rounded-xl focus:bg-white/[0.06] focus:border-orange-500/50 transition-all resize-none" 
                      />
                    </div>

                    <Button 
                      size="lg" 
                      className="w-full h-14 bg-orange-500 hover:bg-orange-600 text-white font-bold text-lg rounded-xl hover:scale-[1.02] transition-all"
                    >
