...
const contactInfo = [
  ...
  },
  {
    icon: MessageSquare,
    title: "WhatsApp",
    description: "Atendimento direto e imediato",
    value: "+351 963 901 577",
    action: "https://wa.me/351963901577"
  },
  {
    icon: MapPin,
    title: "Escritório",
              ...
              >
                <Card className="h-full bg-white/[0.02] border border-white/[0.08] hover:border-orange-500/30 transition-all duration-500 rounded-3xl hover:bg-white/[0.04] transform hover:-translate-y-2">
                  <CardContent className="p-8 text-center">
                    ...
                    <Button 
                      ...
                      onClick={() => {
                        if (info.title === "WhatsApp") {
                          const message = encodeURIComponent("Olá! Vim através do site da Construware e gostaria de saber mais sobre os vossos sistemas.");
                    ...
                    >
                      {info.title === "WhatsApp" ? "Iniciar Conversa" : "Entrar em Contato"}
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                size="lg" 
                className="bg-green-500 hover:bg-green-600 text-white px-10 py-5 h-auto rounded-2xl text-lg md:text-xl font-bold hover:scale-105 transition-all"
                onClick={() => {
