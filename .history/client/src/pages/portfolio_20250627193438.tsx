...
const projects = [
  ...
  },
  {
    ...
    category: "Comércio",
    description: "Plataforma de e-commerce com recomendações por IA e gestão omnichannel.",
    image: "/api/placeholder/600/400",
    technologies: ["Next.js", "Stripe", "Elasticsearch", "GraphQL"],
    metrics: [
      { label: "Vendas/mês", value: "€2M+" },
  ...
  },
  {
    ...
    category: "Startup",
    description: "Plataforma SaaS para gestão de projetos com colaboração em tempo real e automação de workflows.",
    image: "/api/placeholder/600/400",
    technologies: ["Svelte", "Rust", "PostgreSQL", "Websockets"],
    metrics: [
      { label: "Equipas", value: "1k+" },
      { label: "Projetos", value: "10k+" },
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Conheça alguns dos projetos que desenvolvemos e os resultados extraordinários que alcançamos para nossos clientes.
            </p>
          </motion.div>
