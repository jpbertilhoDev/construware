        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h1 className="text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-black tracking-[-0.02em] mb-8 leading-[0.85]">
              <span className="text-white/95">Projetos que</span>
              <br />
              <span className="relative inline-block">
                <span className="bg-gradient-to-r from-orange-200 via-orange-400 via-orange-500 to-orange-700 bg-clip-text text-transparent animate-pulse">
                  revolucionam
                </span>
                <span className="absolute inset-0 bg-gradient-to-r from-orange-200 via-orange-400 via-orange-500 to-orange-700 bg-clip-text text-transparent blur-sm opacity-50 animate-pulse">
                  revolucionam
                </span>
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-8">
              <div className="relative flex-1">
                ...
                <Input 
                  ...
                  className="pl-12 h-16 bg-white/[0.03] border-white/[0.10] text-white text-lg md:text-xl font-medium placeholder:text-white/40 rounded-xl focus:bg-white/[0.06] focus:border-white/30 transition-all"
                  value={searchTerm}
              ...
              <div className="w-full sm:w-auto">
                <Tabs value={selectedCategory} onValueChange={setSelectedCategory} className="w-full">
                  <TabsList className="bg-white/[0.03] border border-white/[0.10] p-1.5 h-16 w-full sm:w-auto backdrop-blur-sm">
                    {categories.map(category => (
                      <TabsTrigger 
                        key={category} 
                        value={category}
                        className="data-[state=active]:bg-orange-500 data-[state=active]:text-white px-6 py-3 rounded-lg text-white/60 hover:text-white/80 transition-all font-bold text-base md:text-lg"
                      >
                        {category}
                      </TabsTrigger>
                    ))}
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            >
              <div className="flex items-center gap-4 mb-2">
                ...
                <span className="text-base md:text-lg font-bold text-orange-400">Em Destaque</span>
              </div>
            </motion.div>
                    ...
                    <div className="relative overflow-hidden rounded-3xl bg-white/[0.008] border border-white/[0.05] hover:border-white/[0.15] transition-all duration-700 hover:bg-white/[0.02]">
                      <div className="flex flex-col lg:flex-row min-h-[500px]">
                        ...
                        <div className="lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center">
                          ...
                          <h3 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black text-white mb-4 leading-tight group-hover:text-orange-400 transition-colors">
                            {project.title}
                          </h3>
                          
                          <p className="text-lg md:text-xl lg:text-2xl text-white/70 mb-8 leading-relaxed font-medium">
                            {project.description}
                          </p>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black text-white">
            ...
            {(searchTerm || selectedCategory !== "Todos") && (
              <div className="text-lg md:text-xl text-white/60 font-bold">
          ...
          {isLoading ? (
            ...
            >
              ...
              <h3 className="text-2xl md:text-3xl font-black text-white mb-3">Nenhum projeto encontrado</h3>
                        ...
                        <div className="group relative rounded-3xl overflow-hidden bg-white/[0.008] border border-white/[0.05] hover:border-white/[0.15] hover:bg-white/[0.02] transition-all duration-500 hover:-translate-y-2">
                          ...
                          <div className="relative overflow-hidden">
                            ...
                            <div className="absolute top-6 left-6">
                              <div className="flex items-center gap-2 px-4 py-2.5 bg-black/70 backdrop-blur-md rounded-xl border border-white/20">
                                <IconComponent className="w-4 h-4 text-orange-400" />
                                <span className="text-white text-sm md:text-base font-bold">{project.category}</span>
                              </div>
                            </div>
                          ...
                          <div className="p-8">
                            <div className="flex items-center gap-2 mb-4">
                              <span className="text-xs md:text-sm font-bold text-orange-400">{project.client.sector}</span>
                              <span className="text-white/30">•</span>
                              <span className="text-xs md:text-sm text-white/60 font-semibold">{project.duration}</span>
                            </div>
                            
                            <h3 className="text-xl md:text-2xl font-black text-white mb-3 leading-tight group-hover:text-orange-400 transition-colors">
                              {project.title}
                            </h3>
                            
                            <p className="text-white/70 text-sm md:text-base mb-6 leading-relaxed line-clamp-2 font-medium">
                              {project.description}
                            </p>
                            ...
                            <div className="flex flex-wrap gap-2 mb-6">
                              {project.technologies.slice(0, 3).map((tech, i) => (
                                <span key={i} className="px-3 py-1.5 bg-white/[0.08] border border-white/[0.12] rounded-lg text-xs md:text-sm text-white/80 font-semibold">
                                  {tech}
                                </span>
                              ))}
                              {project.technologies.length > 3 && (
                                <span className="px-3 py-1.5 bg-white/[0.08] border border-white/[0.12] rounded-lg text-xs md:text-sm text-white/60 font-semibold">
                                  +{project.technologies.length - 3}
                                </span>
                              )}
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <div className="text-sm md:text-base font-bold text-white/95">{project.client.name}</div>
