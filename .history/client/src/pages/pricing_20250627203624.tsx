...
export default function Pricing() {
  return (
    <div className="min-h-screen bg-[#0C0C0C]">
      {/* Hero Section */}
      <section className="py-28 bg-gradient-to-b from-[#0C0C0C] via-[#0F0F11] to-[#0C0C0C] relative overflow-hidden">
        {/* Background elements */}
      ...
      {/* FAQ Section */}
      <section className="py-20 bg-gradient-to-b from-[#0C0C0C] to-[#0F0F11]">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {faqItems.map((item, index) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                viewport={{ once: true }}
                className="bg-white/[0.03] backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:border-orange-500/20 transition-colors duration-200"
              >
                <h3 className="text-lg font-medium mb-3 text-orange-400">{item.question}</h3>
      ...
      <section className="py-20 relative overflow-hidden">
        <div className="absolute inset-0 z-0">
          <div className="absolute top-0 right-0 w-1/2 h-1/2 bg-gradient-to-bl from-orange-500/10 via-orange-400/5 to-transparent blur-[120px]"></div>
          <div className="absolute bottom-0 left-0 w-1/2 h-1/2 bg-gradient-to-tr from-orange-600/10 via-orange-500/5 to-transparent blur-[120px]"></div>
        </div>
        ...
        <div className="container mx-auto px-6 max-w-4xl text-center relative z-10">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6 tracking-tight text-white">
              Pronto para <span className="text-orange-500">revolucionar</span> seus projetos?
            </h2>
            <p className="text-xl text-white/60 mb-8 max-w-2xl mx-auto">
              Transforme sua gestão de obras e aumente a produtividade de sua equipe.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <Button 
                className="bg-orange-500 hover:bg-orange-600 text-white border-0 px-8 py-6 rounded-xl font-medium group transition-all duration-300"
                size="lg"
              >
              ...
              <Button 
                variant="outline"
                className="border-white/10 hover:border-orange-500/20 text-white hover:bg-white/5 px-8 py-6 rounded-xl transition-colors duration-200"
                size="lg"
              >
                Falar com Vendas
              </Button>
