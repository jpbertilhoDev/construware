        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h1 className="text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-black tracking-[-0.02em] mb-8 leading-[0.85]">
              ...
              <br />
              <span className="bg-gradient-to-r from-orange-300 via-orange-400 to-orange-600 bg-clip-text text-transparent animate-pulse [text-shadow:0_0_20px_rgba(251,146,60,0.3),0_0_40px_rgba(251,146,60,0.2),0_0_60px_rgba(251,146,60,0.1)]">
                revolucionam
              </span>
            </h1>
