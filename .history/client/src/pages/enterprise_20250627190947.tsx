...
const testimonials = [
  {
    quote: "A SparkDev desenvolveu nossa plataforma fintech do zero. Em 6 meses tínhamos 50k+ utilizadores ativos e processávamos €10M+ mensalmente.",
    author: "Carlos Silva",
      ...
      <section className="py-16 relative">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Empresas líderes confiam na SparkDev para transformar suas visões em realidade digital.
            </p>
          </motion.div>
