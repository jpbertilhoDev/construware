...
export const projects: Project[] = [
  {
    ...
    description:
      "Plataforma completa para gestão de hospitais com módulos de pacientes, médicos, exames e faturamento.",
    longDescription:
      "Sistema web completo desenvolvido para modernizar a gestão hospitalar, incluindo prontuário eletrônico, agendamento de consultas, controle de estoque de medicamentos e dashboard executivo.",
    coverImage:
      "https://images.unsplash.com/photo-1559757148-5c350d0d3c56?q=80&w=1631&auto=format&fit=crop",
  ...
  },
  {
    ...
    description:
      "Plataforma de e-commerce avançada com múltiplas lojas, idiomas e integração com marketplaces.",
    longDescription:
      "E-commerce completo com gestão de múltiplas lojas, suporte a diferentes moedas e idiomas, integração com marketplaces como Amazon e eBay, sistema de afiliados e analytics avançado.",
    coverImage:
  ...
  },
  {
    ...
    description:
      "Aplicativo mobile para delivery com rastreamento em tempo real e otimização de rotas por IA.",
    longDescription:
      "App mobile completo para delivery com algoritmos de otimização de rotas, rastreamento GPS em tempo real, sistema de avaliações, programa de fidelidade e painel administrativo para restaurantes.",
    coverImage:
      "https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?q=80&w=1481&auto=format&fit=crop",
    category: "App Mobile",
  ...
  },
  {
    ...
    description:
      "ERP completo para gestão industrial com controle de produção, estoque, vendas e financeiro.",
    longDescription:
      "Sistema ERP robusto desenvolvido especificamente para indústrias, incluindo planejamento de produção, controle de qualidade, gestão de fornecedores, vendas B2B e módulo financeiro completo.",
    coverImage:
      "https://images.unsplash.com/photo-1565514020179-026b92b84bb6?q=80&w=1470&auto=format&fit=crop",
  ...
  },
  {
    ...
    description:
      "LMS moderno com videoconferências, gamificação e acompanhamento de progresso para escolas.",
    longDescription:
      "Learning Management System completo com salas de aula virtuais, sistema de gamificação, acompanhamento detalhado de progresso, biblioteca digital e ferramentas de colaboração para educação moderna.",
    coverImage:
  ...
  },
  {
    ...
    description:
      "Plataforma completa para imobiliárias com CRM, portal de imóveis e automação de processos.",
    longDescription:
      "Sistema web completo para gestão imobiliária incluindo CRM avançado, portal público de imóveis, sistema de agendamento de visitas, automação de contratos e dashboard de vendas.",
    coverImage:
