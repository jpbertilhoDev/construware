  ...
  const nextStep = (userResponse?: string, data?: Partial<UserData>) => {
    ...
    switch (step) {
      ...
      case 6:
        ...
        const businessType = businessTypes.find(bt => userData.businessType?.includes(bt.name));
        const employeeRange = employeeRanges.find(er => userData.employees?.includes(er.name));
        const challenge = challenges.find(ch => userData.mainChallenge?.includes(ch.name));
    ...
    <>
      ...
      >
        <Button
          ...
          className="h-16 w-16 rounded-full bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 hover:from-blue-700 hover:via-purple-700 hover:to-blue-900 shadow-2xl shadow-blue-500/30 hover:shadow-blue-500/50 transition-all duration-300 group"
        >
        ...
        <motion.div
          className="absolute -top-3 -right-3 w-8 h-8 bg-gradient-to-r from-orange-400 to-red-500 rounded-full flex items-center justify-center shadow-lg"
          animate={{ 
            rotate: [0, 10, -10, 0],
            scale: [1, 1.1, 1]
          }}
        ...
        <div className="absolute -top-16 -left-20 bg-gray-900 text-white px-3 py-2 rounded-lg text-sm font-medium opacity-90 pointer-events-none">
          IA Avançada 🚀
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            >
              {/* Header */}
              <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 p-4 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm">Análise Técnica + Agendamento Automático</p>
                  </div>
                </div>
                <Button
                        ...
                        <div className="mt-3 space-y-2">
                          {message.options.map((option, index) => (
                            <Button
                              ...
                              className="w-full justify-start bg-white hover:bg-blue-50 border-blue-200 hover:border-blue-300 text-gray-700 hover:text-blue-700 text-sm py-3 h-auto font-medium"
                            >
                              {option}
                            </Button>
                          ))}
              ...
              <div className="p-4 border-t bg-white">
                <form onSubmit={handleTextInput} className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
                  />
                  <Button
                    type="submit"
                    className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 px-6 rounded-xl"
                  >
