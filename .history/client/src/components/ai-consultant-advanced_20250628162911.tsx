...
export function AIConsultantAdvanced() {
  ...
  const generatePersonalizedRecommendations = (businessType: any, employeeRange: any, challenge: any): string => {
    ...
    const recommendations: Record<string, string> = {
      'construction': `🏗️ **SOLUÇÃO COMPLETA PARA CONSTRUÇÃO CIVIL**
...
**💰 ECONOMIA GARANTIDA:** €${savings.total.toLocaleString()}/ano
• Redução de desperdícios: €${savings.operational.toLocaleString()}
• Aumento de produtividade: €${savings.productivity.toLocaleString()}  
• Eliminação de erros: €${savings.errorReduction.toLocaleString()}

**🎯 RESULTADO:** Mais lucro, menos stress, obras sempre no prazo!`,

      'consulting': `💼 **SOLUÇÃO COMPLETA PARA CONSULTORIA**

**💡 O QUE VAI RESOLVER PARA SI:**
• **Clientes Organizados**: Nunca mais perder informações importantes
• **Vendas Automáticas**: Sistema identifica melhores oportunidades
• **Tempo Controlado**: Saber exatamente quanto tempo gasta em cada projeto
• **Faturação Automática**: Facturas geradas automaticamente
• **Relatórios de Performance**: Ver quais projetos dão mais lucro
• **Portal do Cliente**: Clientes acompanham progresso sozinhos

**💰 ECONOMIA GARANTIDA:** €${savings.total.toLocaleString()}/ano
• Mais vendas: €${savings.operational.toLocaleString()}
• Projetos mais eficientes: €${savings.productivity.toLocaleString()}
• Menos tempo administrativo: €${savings.errorReduction.toLocaleString()}

**🎯 RESULTADO:** Mais clientes, mais lucro, menos trabalho administrativo!`,

      'ecommerce': `🛒 **SOLUÇÃO COMPLETA PARA E-COMMERCE**

**💡 O QUE VAI RESOLVER PARA SI:**
• **Loja que Vende Sozinha**: Sistema sugere produtos aos clientes
• **Stock Controlado**: Nunca mais ficar sem produtos importantes
• **Marketing Automático**: Campanhas que se ajustam sozinhas
• **Vendas 24/7**: App móvel para clientes comprarem sempre
• **Pagamentos Seguros**: Integração com todos os métodos
• **Relatórios de Vendas**: Ver o que vende mais em tempo real

**💰 ECONOMIA GARANTIDA:** €${savings.total.toLocaleString()}/ano
• Aumento de vendas: €${savings.operational.toLocaleString()}
• Marketing automático: €${savings.productivity.toLocaleString()}
• Menos carrinhos abandonados: €${savings.errorReduction.toLocaleString()}

**🎯 RESULTADO:** Mais vendas, clientes mais satisfeitos, crescimento garantido!`,

      'restaurant': `🍽️ **SOLUÇÃO COMPLETA PARA RESTAURANTE**

**💡 O QUE VAI RESOLVER PARA SI:**
• **Vendas Organizadas**: Sistema de caixa que nunca falha
• **Delivery Integrado**: Ligação automática com apps de entrega
• **Ingredientes Controlados**: Saber sempre o que tem em stock
• **Reservas Automáticas**: Clientes marcam mesa online
• **Programa de Fidelidade**: Clientes voltam mais vezes
• **Relatórios Diários**: Ver lucro e despesas em tempo real

**💰 ECONOMIA GARANTIDA:** €${savings.total.toLocaleString()}/ano
• Operação mais eficiente: €${savings.operational.toLocaleString()}
• Delivery otimizado: €${savings.productivity.toLocaleString()}
• Menos desperdício: €${savings.errorReduction.toLocaleString()}

**🎯 RESULTADO:** Mais clientes, menos desperdício, operação perfeita!`,

      'services': `⚙️ **SOLUÇÃO COMPLETA PARA SERVIÇOS**

**💡 O QUE VAI RESOLVER PARA SI:**
• **Agendamentos Automáticos**: Clientes marcam serviços online
• **Técnicos Organizados**: Saber sempre quem está onde
• **Clientes Informados**: Portal para acompanhar serviços
• **Faturação Instantânea**: Facturas enviadas automaticamente
• **Histórico Completo**: Ver todo o histórico de cada cliente
• **Relatórios de Performance**: Saber quais serviços dão mais lucro

**💰 ECONOMIA GARANTIDA:** €${savings.total.toLocaleString()}/ano
• Agendamentos otimizados: €${savings.operational.toLocaleString()}
• Técnicos mais produtivos: €${savings.productivity.toLocaleString()}
• Menos tempo administrativo: €${savings.errorReduction.toLocaleString()}

**🎯 RESULTADO:** Mais clientes atendidos, operação sem falhas!`,

      'healthcare': `🏥 **SOLUÇÃO COMPLETA PARA SAÚDE**

**💡 O QUE VAI RESOLVER PARA SI:**
• **Pacientes Organizados**: Todos os dados médicos seguros
• **Consultas Otimizadas**: Agendamento automático sem conflitos
• **Receitas Digitais**: Prescrições enviadas direto para farmácia
• **Telemedicina**: Consultas remotas quando necessário
• **Relatórios Médicos**: Insights de saúde dos pacientes
• **Conformidade Total**: Cumpre todas as leis de proteção de dados

**💰 ECONOMIA GARANTIDA:** €${savings.total.toLocaleString()}/ano
• Operação mais eficiente: €${savings.operational.toLocaleString()}
• Consultas mais rápidas: €${savings.productivity.toLocaleString()}
• Conformidade garantida: €${savings.errorReduction.toLocaleString()}

**🎯 RESULTADO:** Melhor atendimento, pacientes mais satisfeitos!`,

      'education': `🎓 **SOLUÇÃO COMPLETA PARA EDUCAÇÃO**

**💡 O QUE VAI RESOLVER PARA SI:**
• **Aulas Online Perfeitas**: Plataforma completa de ensino
• **Avaliações Automáticas**: Testes corrigidos instantaneamente
• **Progresso dos Alunos**: Ver evolução de cada estudante
• **Pais Informados**: Portal para acompanhar filhos
• **Gamificação**: Alunos mais motivados a aprender
• **Certificados Automáticos**: Diplomas gerados automaticamente

**💰 ECONOMIA GARANTIDA:** €${savings.total.toLocaleString()}/ano
• Ensino automatizado: €${savings.operational.toLocaleString()}
• Professores mais eficientes: €${savings.productivity.toLocaleString()}
• Menos trabalho administrativo: €${savings.errorReduction.toLocaleString()}

**🎯 RESULTADO:** Alunos mais engajados, ensino de qualidade!`,

      'other': `🏢 **SOLUÇÃO PERSONALIZADA PARA O SEU NEGÓCIO**

**💡 O QUE VAI RESOLVER PARA SI:**
• **Análise Específica**: Desenvolvimento focado nas suas necessidades
• **Integração Completa**: Liga todos os seus sistemas atuais
• **Dashboard Simples**: Ver tudo importante numa só tela
• **Automação Inteligente**: Tarefas repetitivas feitas automaticamente
• **Crescimento Garantido**: Sistema cresce com o seu negócio
• **Suporte Dedicado**: Equipa sempre disponível para ajudar

**💰 ECONOMIA GARANTIDA:** €${savings.total.toLocaleString()}/ano
• Processos otimizados: €${savings.operational.toLocaleString()}
• Equipa mais produtiva: €${savings.productivity.toLocaleString()}
• Menos custos operacionais: €${savings.errorReduction.toLocaleString()}

**🎯 RESULTADO:** Negócio mais eficiente, mais tempo para crescer!`
    };
  ...
  const handleUserResponse = (response: string, data?: Partial<UserData>) => {
    console.log('🔍 User Response:', { response, currentStep, userData });
  ...
  const nextStep = (userResponse?: string, data?: Partial<UserData>) => {
    ...
    console.log('🚀 NextStep:', { userResponse, currentStep, newStep: step, userData });

    switch (step) {
      case 1:
        console.log('📝 Executing Step 1: Initial greeting');
        simulateTyping(() => {
          addMessage(
      ...
      case 2:
        ...
        console.log('📝 Step 2: Ask business type, name:', userResponse);
      ...
      case 3:
        ...
        console.log('📝 Step 3: Ask employee count, businessType:', userResponse);
      ...
      case 4:
        ...
        console.log('📝 Step 4: Ask main challenge, employees:', userResponse);
      ...
      case 5:
        ...
        console.log('📝 Step 5: Ask current system, challenge:', userResponse);
      ...
      case 6:
        // User provided current system, generate analysis
        console.log('📝 Step 6: Generate analysis, currentSystem:', userResponse);
        ...
        simulateTyping(() => {
          addMessage(
            `🚀 **Análise IA Completa!**\n\n${recommendations}\n\n📱 **Enviando relatório para a nossa equipa via WhatsApp...**`,
            'ai'
          );
          
          // Send WhatsApp report automatically
          sendWhatsAppReport(updatedUserData, recommendations).then((success) => {
            if (success) {
              setTimeout(() => {
                addMessage(
                  `✅ **Relatório enviado com sucesso!**\n\n📅 **Como prefere ver uma demonstração ao vivo?**\n\n*Recomendo uma demo personalizada para mostrar como vai resolver os seus problemas específicos.*`,
                  'ai',
              ...
              setTimeout(() => {
                addMessage(
                  `⚠️ **Relatório será enviado em breve.**\n\n📅 **Como prefere ver uma demonstração ao vivo?**\n\n*Recomendo uma demo personalizada para mostrar como vai resolver os seus problemas específicos.*`,
                  'ai',
                  generateMeetingOptions()
                );
              }, 2000);
      ...
      case 7:
        // User selected meeting option
        console.log('📝 Step 7: Handle meeting booking, option:', userResponse);
