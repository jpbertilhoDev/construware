      ...
      <nav className="container mx-auto px-4 sm:px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4 sm:space-x-12">
            <Link href="/" className="flex items-center">
              <img 
                ...
                alt="Construware" 
                className="w-28 sm:w-36 h-auto transition-transform hover:scale-105"
              />
            </Link>
          ...
          <div className="flex items-center space-x-3 sm:space-x-4">
            ...
            <Button className="ml-6 bg-gradient-to-r from-orange-500 to-yellow-500 hover:from-orange-600 hover:to-yellow-600 text-white font-medium px-6 py-2 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-orange-500/25">
              Orçamento Grátis
            </Button>
          </div>
        </div>
