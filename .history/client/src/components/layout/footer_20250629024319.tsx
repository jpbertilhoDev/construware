            ...
            <Link href="/" className="flex items-center mb-4 sm:mb-6 group">
              <div className="flex items-center space-x-3">
                ...
                <div className="relative">
                  <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg flex items-center justify-center shadow-lg group-hover:shadow-orange-500/25 transition-all duration-300 group-hover:scale-110">
                    <div className="w-3 h-3 sm:w-4 sm:h-4 bg-white rounded-sm flex items-center justify-center">
                      <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-gradient-to-br from-orange-500 to-orange-600 rounded-sm"></div>
                    </div>
                  </div>
                  {/* Subtle glow effect */}
                  <div className="absolute inset-0 w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg opacity-20 blur-sm group-hover:opacity-40 transition-all duration-300"></div>
                </div>
                
                {/* Brand Name */}
                <div className="flex flex-col">
                  <span className="text-lg sm:text-xl font-bold bg-gradient-to-r from-white to-gray-200 bg-clip-text text-transparent group-hover:from-orange-100 group-hover:to-white transition-all duration-300">
                    Construware
                  </span>
                  <span className="text-xs text-orange-400 font-medium opacity-80 -mt-0.5">
                    BUILD SMART
                  </span>
                </div>
              </div>
