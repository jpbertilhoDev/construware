...
*Obrigado por confiar na nossa IA!* 🎉✨`;
    ...
    simulateTyping(() => {
      addMessage(
        `✅ **WhatsApp aberto com sucesso!**\n\n📱 Número confirmado: +${formattedPhone}\n📄 Relatório personalizado pré-preenchido\n\n🎯 **INSTRUÇÕES:**\n1️⃣ O WhatsApp abriu numa nova janela\n2️⃣ Clique em "Enviar" para receber o relatório\n3️⃣ Guarde a mensagem para referência\n\n⚡ **Bonus**: Nossa equipa também foi notificada e entrará em contacto em breve!`,
        'ai'
      );
