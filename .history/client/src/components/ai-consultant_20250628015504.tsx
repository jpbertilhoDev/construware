...
export function AIConsultant() {
  ...
  const nextStep = (userResponse?: string, data?: Partial<UserData>) => {
    ...
    switch (step) {
      ...
      case 6:
        addMessage(
          `Ótimo! Agora só preciso do seu email para enviar a análise personalizada completa.\n\nQual é o seu email?`,
          'ai'
        );
        break;
