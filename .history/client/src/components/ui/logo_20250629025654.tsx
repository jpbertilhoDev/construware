    ...
    <Link href="/" className={`flex items-center space-x-3 group ${className}`}>
      ...
      <div className="relative">
        ...
        >
          {/* Top Right Square */}
          <motion.div
            className={`${classes.medium} bg-gradient-to-br from-orange-500 to-orange-600 rounded-md absolute top-0 right-0 shadow-lg`}
          ...
          <motion.div
            className={`${classes.large} bg-gradient-to-br from-orange-500 to-orange-600 rounded-md absolute bottom-0 left-0 shadow-lg`}
            whileHover={{ scale: 1.1, rotate: -2 }}
