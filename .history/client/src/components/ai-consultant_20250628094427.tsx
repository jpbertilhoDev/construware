...
Equipa Construware
  ...
  const notifyTeamWhatsAppRequest = async (phone: string, clientName: string) => {
    const teamNotification = `🤖 *PEDIDO WHATSAPP - IA CONSULTORA*
...
🎯 *AÇÃO NECESSÁRIA:*
✅ Cliente vai receber relatório via link WhatsApp
✅ Fazer follow-up em 2-4 horas
✅ Mencionar que viu o interesse em WhatsApp

⚡ *PRIORIDADE: MÉDIA-ALTA*
Cliente demonstrou interesse específico em comunicação via WhatsApp.

📞 Para contactar: +${phone}`;
