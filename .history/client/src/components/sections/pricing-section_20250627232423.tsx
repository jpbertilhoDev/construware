      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            Soluções profissionais com preços ajustados ao mercado português.
          </p>
        </motion.div>
        ...
        >
          <div className="text-center p-6 rounded-2xl bg-white/[0.02] border border-white/10">
            ...
            <div className="text-gray-500 text-xs">Sem juros</div>
          </div>
          
          <div className="text-center p-6 rounded-2xl bg-white/[0.02] border border-white/10">
            <div className="text-3xl font-bold text-orange-400 mb-2">24/7</div>
            <div className="text-white text-sm font-medium mb-1">Suporte técnico</div>
            <div className="text-gray-500 text-xs">Em português</div>
          </div>
