        ...
        >
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <motion.h2 
              ...
              viewport={{ once: true }}
            >
              Amado por <span className="bg-gradient-to-r from-orange-500 to-orange-400 bg-clip-text text-transparent">desenvolvedores</span> e empresas
            </motion.h2>
            ...
            <motion.p 
              ...
              viewport={{ once: true }}
            >
              Empresas de todos os tamanhos confiam na Construware 
              para transformar suas ideias em soluções digitais de excelência.
            </motion.p>
          </div>
          ...
          >
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-white/90 font-light leading-relaxed italic mb-6 sm:mb-8">
              "A Construware transformou nossa visão em realidade digital. Nunca antes tivemos um parceiro tão dedicado e competente. Economizamos tempo, reduzimos custos de desenvolvimento e lançamos nosso produto com qualidade excepcional."
            </p>
            ...
            <div className="flex flex-wrap sm:flex-nowrap items-center gap-4 sm:gap-0">
              ...
              <div className="ml-0 sm:ml-4">
                ...
                <div className="text-xs text-white/60">Diretor de TI, Retail Digital</div>
              </div>
