        ...
        >
          ...
          >
            <div className="inline-flex items-center glass-effect px-6 py-3 rounded-2xl border border-white/10 mb-8">
              ...
              <span className="text-white/80 font-medium">Transforme sua gestão hoje</span>
            </div>
          </motion.div>

          <h2 className="text-5xl md:text-7xl font-black mb-8 leading-[0.9]">
            <span className="gradient-text block">Pronto para</span>
            <span className="gradient-text-primary block">Revolucionar?</span>
          </h2>
          
          <p className="text-xl md:text-2xl text-white/60 mb-12 max-w-4xl mx-auto leading-relaxed">
            Mais de <strong className="text-white font-bold">1.200+ empresas</strong> já transformaram 
            seus processos e aumentaram a eficiência em <strong className="text-orange-400">40%</strong>
          </p>
          ...
          >
            <div className="text-center">
              <div className="text-3xl font-black gradient-text-primary mb-2">40%</div>
              <div className="text-white/60 text-sm">Redução de Atrasos</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-black gradient-text-primary mb-2">24/7</div>
              <div className="text-white/60 text-sm">Suporte Dedicado</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-black gradient-text-primary mb-2">7 dias</div>
              <div className="text-white/60 text-sm">Teste Grátis</div>
            </div>
          </motion.div>
        </motion.div>
      </div>
