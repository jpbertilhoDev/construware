      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-white/60 max-w-3xl mx-auto font-light">
            Interface real do sistema que está transformando a gestão de obras.
            ...
            >
              ...
              <div className="flex-1 space-y-8">
                <div className="inline-flex items-center px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs text-white/60">
                  <span className="mr-2">{feature.isScreenshot ? "🖥️" : "✦"}</span> 
                  {feature.isScreenshot ? "Interface Real" : `Feature ${feature.id - 1}`}
                </div>
                <div>
              ...
              <div className="flex-1 relative">
                <motion.div
                  className="relative"
                  whileHover={{ scale: feature.isScreenshot ? 1.01 : 1.02, rotate: feature.isScreenshot ? 0 : 0.5 }}
                ...
                >
                  <div className={`relative rounded-2xl bg-gradient-to-br ${feature.gradient} p-[2px] shadow-2xl shadow-${feature.gradient.split('-')[1]}/20`}>
                    <div className={`${feature.isScreenshot ? 'bg-transparent' : 'bg-[#0A0A0A]'} rounded-xl ${feature.isScreenshot ? 'p-2' : 'p-8'} backdrop-blur-md`}>
                      <div className={`transform ${feature.isScreenshot ? 'scale-100' : 'scale-110'}`}>
