...
const pricingPlans: PricingPlan[] = [
  {
    ...
    discount: "50% OFF",
    justification: "Preço justo baseado em 40-60 horas de trabalho especializado. Inclui design, desenvolvimento e configurações que normalmente custam €2.500 no mercado português."
  },
  {
    id: "system",
