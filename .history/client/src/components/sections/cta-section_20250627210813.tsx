        ...
        >
          ...
          >
            <div className="inline-flex items-center glass-effect px-6 py-3 rounded-2xl border border-white/10 mb-8">
              ...
              <span className="text-white/80 font-medium">Desenvolva seu futuro digital hoje</span>
            </div>
          </motion.div>
          ...
          >
            <div className="text-center">
              ...
              <div className="text-white/60 text-sm">Código Proprietário</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              <div className="text-3xl font-black gradient-text-primary mb-2">∞</div>
              <div className="text-white/60 text-sm">Possibilidades</div>
            </div>
          </motion.div>
        </motion.div>
      </div>
