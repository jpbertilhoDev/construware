    ...
    <section id="pricing" className="py-32 bg-black/95 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            return (
              ...
              >
                   ...
                   <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-10">
                     <div className="px-3 py-1 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full text-xs font-semibold text-white shadow-lg">
                       Mais Popular
                     </div>
                   </div>
                 )}
        ...
        >
          ...
          <div className="w-px h-8 bg-white/10"></div>
          <div className="text-center">
            <div className="text-lg font-bold text-white mb-1">30 dias</div>
