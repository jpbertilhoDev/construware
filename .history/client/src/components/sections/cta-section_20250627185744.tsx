        ...
        >
          ...
          >
            <div className="inline-flex items-center glass-effect px-6 py-3 rounded-2xl border border-white/10 mb-8">
              ...
              <span className="text-white/80 font-medium">Transforme sua ideia em realidade</span>
            </div>
          </motion.div>
          ...
          <p className="text-xl md:text-2xl text-white/60 mb-12 max-w-4xl mx-auto leading-relaxed">
            ...
            seus negócios com nossas soluções e aumentaram a eficiência em <strong className="text-orange-400">60%</strong>
          </p>
          ...
          >
            <div className="text-center">
              ...
              <div className="text-white/60 text-sm">Aumento de Eficiência</div>
            </div>
            <div className="text-center">
