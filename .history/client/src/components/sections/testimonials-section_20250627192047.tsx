        ...
        >
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <motion.p 
              ...
              viewport={{ once: true }}
            >
              Startups, scale-ups e empresas estabelecidas confiam na Construware 
          ...
          >
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-white/90 font-light leading-relaxed italic mb-6 sm:mb-8">
                                "A Construware não apenas desenvolveu nosso software, mas transformou completamente nossa operação. 
