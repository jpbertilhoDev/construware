...
const testimonials = [
  {
    ...
    content: "A SparkDev transformou nossa ideia em uma aplicação incrível. O sistema de gestão que desenvolveram aumentou nossa eficiência em 60% em apenas 3 meses.",
    avatar: "CS",
  ...
  },
  {
    ...
    role: "CTO",
    company: "FinanceFlow",
    content: "Profissionalismo excepcional. A equipe da SparkDev entendeu perfeitamente nossos requisitos complexos e entregou uma solução fintech robusta e escalável.",
    avatar: "AC",
