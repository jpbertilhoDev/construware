                ...
                <div className="mt-8 p-6 bg-gradient-to-r from-slate-700/30 to-slate-600/30 rounded-2xl border border-slate-600/50 backdrop-blur-sm">
                 ...
                 <div className="mt-6">
                   <button 
                     ...
                     className="w-full bg-gradient-to-r from-orange-500/30 to-red-500/30 hover:from-orange-500/50 hover:to-red-500/50 border border-orange-500/50 text-orange-300 hover:text-white py-4 px-6 rounded-xl transition-all duration-300 text-sm font-bold backdrop-blur-sm shadow-lg hover:shadow-orange-500/25"
                   >
