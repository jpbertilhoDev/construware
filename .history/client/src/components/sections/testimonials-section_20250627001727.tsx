...
const testimonials = [
  {
    ...
    content: "O Construware é uma revolução. Reduzimos 40% dos custos operacionais e aumentamos nossa produtividade significativamente.",
    avatar: "CS",
    highlight: "40% redução de custos"
  },
  {
    id: 2,
    name: "Ana Costa", 
    role: "Engenheira Civil",
    company: "Edificar Construtora",
    content: "Finalmente um sistema que entende nossa realidade. A colaboração em tempo real transformou como nossa equipe trabalha.",
    avatar: "AC",
    highlight: "Colaboração transformada"
  },
  {
    id: 3,
    name: "Roberto Santos",
    ...
    content: "Interface intuitiva, funcionalidades poderosas. O Construware elevou nossos projetos a um novo patamar de qualidade e eficiência.",
    avatar: "RS",
    highlight: "Qualidade elevada"
  },
  {
    id: 4,
    ...
    company: "TechBuild",
    content: "A automação de relatórios nos economiza horas semanais. Dashboard intuitivo e insights valiosos que ajudam nas tomadas de decisão.",
    avatar: "MO", 
    highlight: "Horas economizadas"
  },
  {
    id: 5,
    name: "Paulo Mendes",
    role: "CEO",
    company: "Construções Premium",
    content: "ROI impressionante em menos de 3 meses. O Construware não é apenas um software, é um parceiro estratégico que nos ajuda a crescer.",
    avatar: "PM",
    highlight: "ROI em 3 meses"
  },
  {
    id: 6,
    name: "Fernanda Lima",
    role: "Coordenadora BIM",
    company: "Inovação Construtiva", 
    content: "Integração perfeita com nossas ferramentas BIM. A sincronização automática de dados eliminou retrabalhos e melhorou nossa precisão em 95%.",
    avatar: "FL",
    highlight: "95% mais precisão"
  },
  {
    id: 7,
    name: "Ricardo Oliveira",
    role: "Engenheiro Estrutural",
    company: "Estruturas Inovadoras",
    content: "A visualização 3D das estruturas e a análise de carga integrada economizaram semanas de trabalho em cada projeto complexo.",
    avatar: "RO",
    highlight: "Semanas economizadas"
  },
  {
    id: 8,
    ...
    content: "O controle financeiro e previsão de fluxo de caixa nos ajudou a evitar surpresas e manter o orçamento sob controle em todos os projetos.",
    avatar: "JM",
    highlight: "Orçamento controlado"
  },
  {
    id: 9,
    name: "Marcos Vieira",
    role: "Gerente de Canteiro",
    company: "Obras Precisas",
    content: "O aplicativo móvel nos permite gerenciar tudo em tempo real diretamente do canteiro. A comunicação com o escritório nunca foi tão eficiente.",
    avatar: "MV",
    highlight: "Gestão em tempo real"
  }
];
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <motion.h2 
              ...
              viewport={{ once: true }}
            >
              Amado por <span className="bg-gradient-to-r from-orange-500 to-orange-400 bg-clip-text text-transparent">profissionais</span> de construção
            </motion.h2>
            ...
            <motion.p 
              ...
              viewport={{ once: true }}
            >
              Engenheiros, arquitetos e construtoras do Brasil inteiro confiam no Construware 
              para elevar seus projetos a um novo patamar de excelência.
            </motion.p>
          </div>
          ...
          >
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-white/90 font-light leading-relaxed italic mb-6 sm:mb-8">
              "O Construware revolucionou nossa forma de trabalhar. Nunca antes tivemos uma visibilidade tão clara dos nossos projetos. Economizamos tempo, reduzimos custos e aumentamos nossa produtividade de forma impressionante."
            </p>
            ...
            <div className="flex flex-wrap sm:flex-nowrap items-center gap-4 sm:gap-0">
              ...
              <div className="ml-0 sm:ml-4">
                ...
                <div className="text-xs text-white/60">CEO, Construções Premium</div>
              </div>
        ...
        <div className="relative w-full overflow-hidden py-4 sm:py-6 before:absolute before:left-0 before:top-0 before:z-10 before:h-full before:w-20 sm:before:w-36 before:bg-gradient-to-r before:from-[#0C0C0C] before:to-transparent after:absolute after:right-0 after:top-0 after:z-10 after:h-full after:w-20 sm:after:w-36 after:bg-gradient-to-l after:from-[#0C0C0C] after:to-transparent">
          ...
          >
            ...
            {[...testimonials, ...testimonials].map((testimonial, index) => (
              ...
              >
                <div className="h-full rounded-lg sm:rounded-xl bg-white/[0.03] backdrop-blur-sm border border-white/10 p-4 sm:p-6 relative overflow-hidden transition-all duration-300 hover:border-orange-500/30 hover:shadow-lg hover:shadow-orange-500/5">
                  {/* Subtle quote icon */}
                  <div className="absolute top-3 sm:top-4 right-3 sm:right-4 opacity-20 group-hover:opacity-30 transition-opacity duration-300">
                    <Quote className="w-4 h-4 sm:w-6 sm:h-6 text-orange-400" />
                  </div>
                  
                  {/* Testimonial content */}
                  <p className="text-white/80 leading-relaxed mb-4 sm:mb-6 text-xs sm:text-sm line-clamp-4">
                    "{testimonial.content}"
                  </p>
                  
                  {/* Author info with hover effect */}
                  <div className="flex items-center group-hover:translate-y-0 translate-y-0 transition-transform duration-300">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-orange-500 to-orange-400 rounded-full flex items-center justify-center text-white font-medium text-[10px] sm:text-xs shadow-sm shadow-orange-500/20 group-hover:shadow-md group-hover:shadow-orange-500/30 transition-shadow duration-300">
                      {testimonial.avatar}
                    </div>
                    <div className="ml-3">
                      <div className="font-medium text-white text-xs sm:text-sm">{testimonial.name}</div>
                      <div className="text-[10px] sm:text-xs text-white/50">{testimonial.role}, {testimonial.company}</div>
                    </div>
                  </div>
                  
                  {/* Highlight badge with improved visibility */}
                  <div className="absolute top-4 sm:top-6 left-4 sm:left-6 text-[10px] sm:text-xs font-medium px-1.5 sm:px-2 py-0.5 sm:py-1 bg-orange-500/10 border border-orange-500/20 rounded-full text-orange-400">
        ...
        >
          <motion.a 
            ...
            whileTap={{ scale: 0.98 }}
          >
            Comece a transformar seus projetos
            <ArrowRight className="ml-2 w-4 h-4 sm:w-5 sm:h-5 group-hover:translate-x-1 transition-transform duration-300" />
          </motion.a>
          
          <p className="text-white/50 mt-4 sm:mt-6 text-xs sm:text-sm">
            Junte-se a mais de <span className="text-orange-400 font-medium">5.000+ profissionais</span> satisfeitos
          </p>
        </motion.div>
      </div>
    </section>
