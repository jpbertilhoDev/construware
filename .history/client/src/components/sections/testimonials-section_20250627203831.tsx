...
const testimonials = [
  {
    ...
    content: "A Construware desenvolveu nossa plataforma de e-commerce em tempo recorde. A qualidade do código e a atenção aos detalhes superaram nossas expectativas.",
    avatar: "CS",
    highlight: "Entrega em 6 semanas"
  },
  {
    id: 2,
    name: "Ana Costa", 
    ...
    content: "Precisávamos de um sistema complexo de gestão. A equipe entendeu perfeitamente nossas necessidades e entregou uma solução robusta e escalável.",
    avatar: "AC",
    highlight: "Sistema escalável"
  },
  {
    id: 3,
    name: "Roberto Santos",
    role: "Founder", 
    company: "FinTech Porto",
    content: "Desenvolveram nossa aplicação fintech com os mais altos padrões de segurança. O suporte pós-lançamento tem sido excepcional.",
    avatar: "RS",
  ...
  },
  {
    ...
    content: "A aplicação mobile que criaram revolucionou como nossos pacientes interagem com nossos serviços. Interface intuitiva e performance excelente.",
    avatar: "MO", 
    highlight: "UX excepcional"
  },
  {
    id: 5,
    name: "Paulo Mendes",
    ...
    content: "ROI impressionante em menos de 3 meses. O sistema automatizou nossos processos e aumentou nossa eficiência em 40%. Investimento que valeu cada euro.",
    avatar: "PM",
  ...
  },
  {
    ...
    company: "EdTech Futuro", 
    content: "Integraram IA de forma inteligente em nossa plataforma educacional. A solução não apenas atendeu nossas necessidades atuais, mas nos preparou para o futuro.",
    avatar: "FL",
  ...
  },
  {
    ...
    content: "Como startup, precisávamos de uma solução completa e acessível. Entregaram um MVP incrível que nos ajudou a captar investimento.",
    avatar: "RO",
    highlight: "MVP de sucesso"
  },
  {
    id: 8,
    ...
    content: "O sistema de logística que desenvolveram otimizou nossas rotas e reduziu custos operacionais em 30%. Tecnologia de ponta aplicada na prática.",
    avatar: "JM",
    highlight: "30% economia"
  },
  {
    id: 9,
    name: "Marcos Vieira",
    ...
    content: "Desenvolveram nossa plataforma imobiliária com funcionalidades que nem sabíamos que precisávamos. Visão técnica excepcional e execução perfeita.",
    avatar: "MV",
    highlight: "Inovação completa"
  }
];
