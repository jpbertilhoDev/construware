        ...
        {isOpen && (
          ...
          >
            <motion.div
              ...
              style={{
                background: 'rgba(255, 167, 48, 0.22)',
                borderRadius: '16px',
                boxShadow: '0 4px 30px rgba(0, 0, 0, 0.1)',
                backdropFilter: 'blur(8.9px)',
                WebkitBackdropFilter: 'blur(8.9px)',
                border: '1px solid rgba(255, 167, 48, 0.3)'
              }}
            >
              {/* Header */}
              ...
              {/* Messages */}
              <CardContent className="flex-1 overflow-y-auto p-4 space-y-4" style={{ background: 'rgba(0, 0, 0, 0.3)' }}>
                    ...
                    <div className={`max-w-[85%] ${message.type === 'user' ? 'order-2' : ''}`}>
                      <div 
                        className={`p-4 rounded-2xl ${
                          message.type === 'ai' 
                            ? 'border border-orange-500/30 text-white shadow-sm' 
                            : 'bg-gradient-to-r from-orange-500 to-orange-400 text-white'
                        }`}
                        style={message.type === 'ai' ? {
                          background: 'rgba(255, 167, 48, 0.15)',
                        ...
                        <div className="mt-3 space-y-2">
                          {message.options.map((option, index) => (
                            <Button
                              ...
                              className="w-full justify-start hover:bg-orange-500/20 border-orange-500/30 hover:border-orange-500/50 text-white hover:text-orange-100 text-sm py-3 h-auto font-medium transition-all duration-200"
                              style={{
                                background: 'rgba(255, 167, 48, 0.1)',
                ...
                {isTyping && (
                  ...
                  >
                    ...
                    <div 
                      className="border border-orange-500/30 p-4 rounded-2xl shadow-sm"
                      style={{
                        background: 'rgba(255, 167, 48, 0.15)',
                        backdropFilter: 'blur(5px)',
                        WebkitBackdropFilter: 'blur(5px)'
              ...
              {/* Input */}
              <div className="p-4 border-t border-orange-500/30" style={{ background: 'rgba(0, 0, 0, 0.2)' }}>
                <form onSubmit={handleTextInput} className="flex gap-2">
                      ...
                      className="flex-1 px-4 py-3 border border-orange-500/30 text-white placeholder:text-orange-200/60 rounded-xl focus:outline-none focus:border-orange-500/50 focus:ring-2 focus:ring-orange-500/20"
                      style={{
                        background: 'rgba(255, 167, 48, 0.15)',
                        backdropFilter: 'blur(5px)',
                        WebkitBackdropFilter: 'blur(5px)'
